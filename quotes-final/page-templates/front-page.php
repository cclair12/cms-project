...
<ul class="bxslider">
	<li>
		<div class="oneslide">
			<img src="http://localhost:8080/wordpress/wp-content/uploads/2018/03/banner1.jpg" alt=""  />
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
					<img src="http://localhost:8080/wordpress/wp-content/uploads/2018/03/slide1.jpg" alt="" class="os-animation" data-os-animation="fadeInRight" data-os-animation-delay="0.4s">
				</div>
			</div>
		</div>
	</li>
	<li>
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
					<img src="http://localhost:8080/wordpress/wp-content/uploads/2018/03/slide1.jpg" alt="">
				</div>
			</div>
		</div>
	</li>
		...
		<div class="row">
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
				<div class="imgdivleft">
					<img src="http://localhost:8080/wordpress/wp-content/uploads/2018/03/poster1.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.5s"/>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="imgdivright">
							<img src="http://localhost:8080/wordpress/wp-content/uploads/2018/03/poster2.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.6s"/>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="imgdivrightinner">
							<img src="http://localhost:8080/wordpress/wp-content/uploads/2018/03/poster3.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.7s"/>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="imgdivrightinner">
							<img src="http://localhost:8080/wordpress/wp-content/uploads/2018/03/poster4.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.8s"/>
						</div>
					</div>
				</div>
			</div>
